# Padrão de Projeto - Nome do Padrão
...
_Descrever o objetivo central do Abstract Factory._
...
_Listar os papéis principais: Abstract Factory, Concrete Factory, Abstract Product, Concrete Product e Client._
...
_Citar padrões que se conectam ao Abstract Factory, como Factory Method, Builder, Prototype e Singleton._
